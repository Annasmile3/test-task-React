...
Post.getInitialProps = function _callee(ctx) {
  var id, post, commentsFromServer, Filteredcomments;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          post = _context.sent;
          _context.next = 6;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(axios.get('https://simple-blog-api.crew.red/comments'));

        case 6:
          commentsFromServer = _context.sent;
          Filteredcomments = commentsFromServer.data.filter(function (comment) {
...
//# sourceMappingURL=[id].js.10d51a4cb930ff385f69.hot-update.js.map