...
var Post = function Post(props) {
  ...
  var _useState2 = Object(react__WEBPACK_IMPORTED_MODULE_2__["useState"])(props.comments),
      commentList = _useState2[0],
      setComments = _useState2[1]; // const handleInputChange = ({ target }: ChangeEvent<HTMLInputElement>) => {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          id = ctx.query.id;
          _context.next = 3;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(ctx.store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["fetchPost"])(id)));

        case 3:
          post = _context.sent;
          _context.next = 6;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(ctx.store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["fetchComments"])()));
...
//# sourceMappingURL=[id].js.098b8eb973d656f88b00.hot-update.js.map