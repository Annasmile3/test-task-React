...
/* harmony import */ var _api_client__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../api/client */ "./api/client.ts");
...
var Post = function Post(props) {
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    if (comment.trim() !== '') {
      Object(_api_client__WEBPACK_IMPORTED_MODULE_6__["createComment"])({
        body: comment,
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          store = _ref2.store;
          id = context.query.id;
          post = store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["fetchPost"])(id)); // const post = await getPost(id);

          _context.next = 5;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_api_client__WEBPACK_IMPORTED_MODULE_6__["getComments"])());
...
//# sourceMappingURL=[id].js.56f795414ca005ceefc9.hot-update.js.map