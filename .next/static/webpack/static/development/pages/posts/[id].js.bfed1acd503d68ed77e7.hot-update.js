  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          id = ctx.query.id;
          post = ctx.store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["fetchPost"])(id));
          console.log(ctx.store, ctx.query);
...
//# sourceMappingURL=[id].js.bfed1acd503d68ed77e7.hot-update.js.map