...
Post.getInitialProps = function _callee(_ref2) {
  var ctx, _Component$getInitial, id, post;
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.async(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ctx = _ref2.ctx;
          _Component$getInitial = Component.getInitialProps(ctx.context.query), id = _Component$getInitial.id;
...
//# sourceMappingURL=[id].js.4e63cc06dd6499ca158e.hot-update.js.map