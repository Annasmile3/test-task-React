...
var NewPost = function NewPost(_ref) {
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    if (title.trim() !== '' && body.trim() !== '') {
      store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["addPost"])({
        title: title,
        body: body
      }));
      setTitle('');
...
NewPost.getInitialProps = function (_ref2) {
  var store = _ref2.store;
  var posts = store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["fetchPosts"])());
  console.log(store);
  return posts;
};
...
//# sourceMappingURL=new.js.1233a151fd4656907e34.hot-update.js.map