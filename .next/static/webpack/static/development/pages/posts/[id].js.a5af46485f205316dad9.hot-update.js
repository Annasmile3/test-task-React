...
Post.getInitialProps = function _callee(_ref2) {
  var Component, _Component$getInitial, id, post;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _Component$getInitial = Component.getInitialProps(context.query), id = _Component$getInitial.id;
          post = store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_4__["fetchPost"])(id));
          console.log(post);
...
//# sourceMappingURL=[id].js.a5af46485f205316dad9.hot-update.js.map