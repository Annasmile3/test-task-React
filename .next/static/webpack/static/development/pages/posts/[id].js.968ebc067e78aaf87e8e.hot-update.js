...
/* harmony import */ var _api_client__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../api/client */ "./api/client.ts");
...
var Post = function Post(props) {
  ...
  var handleSubmit = function handleSubmit(e) {
    ...
    if (comment.trim() !== '') {
      Object(_api_client__WEBPACK_IMPORTED_MODULE_5__["createComment"])({
        body: comment,
...
Post.getInitialProps = function _callee(context, _ref2) {
  var store, id, posts, post, commentsFromServer, comments;
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 5;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_api_client__WEBPACK_IMPORTED_MODULE_5__["getPost"])(id));

        case 5:
          post = _context.sent;
          _context.next = 8;
          return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(Object(_api_client__WEBPACK_IMPORTED_MODULE_5__["getComments"])());

        case 8:
          commentsFromServer = _context.sent;
          comments = commentsFromServer.filter(function (comment) {
...
//# sourceMappingURL=[id].js.968ebc067e78aaf87e8e.hot-update.js.map